...
export const UNLOCK_DESCRIPTIONS = {
    ...
    [UNLOCK_LEVELS.MORE_EXTRA_BALL_BRICKS]: "Better Loot! Levels will now spawn more '+1 Ball' bricks.",
    ...
    [UNLOCK_LEVELS.EXTRA_BALL_2]: "+1 Starting Ball! You now start each run with 4 balls.",
